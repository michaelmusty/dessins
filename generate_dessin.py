...
<body>
    <div class="container">
        ...
        <div class="metadata">
            ...
            <p><strong>LMFDB:</strong> <a href="https://beta.lmfdb.org/Belyi/galmap/{galmap_label}" target="_blank">View on LMFDB</a></p>
        </div>
...
<body>
    <div class="container">
        ...
        <div class="metadata">
            ...
            <p><strong>LMFDB:</strong> <a href="https://beta.lmfdb.org/Belyi/passport/{passport_label}" target="_blank">View on LMFDB</a></p>
        </div>
